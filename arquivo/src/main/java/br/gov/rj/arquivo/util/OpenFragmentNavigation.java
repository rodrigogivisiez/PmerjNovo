 ...
 */
public class OpenFragmentNavigation extends SingleLiveEvent<Integer> {

    public void observe(LifecycleOwner owner, final DestinoObserver observer) {
    ...
    public interface DestinoObserver {
        /**6
